        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__employee__job_id__25869641",
                        column: x => x.job_id,
                        principalTable: "jobs",
                        principalColumn: "job_id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK__employee__pub_id__286302EC",
                        column: x => x.pub_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__pub_info__pub_id__20C1E124",
                        column: x => x.pub_id,
                        principalTable: "publishers",
                        principalColumn: "pub_id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__titles__pub_id__08EA5793",
                        column: x => x.pub_id,
                        principalTable: "publishers",
                        principalColumn: "pub_id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.ForeignKey(
                        name: "FK__discounts__stor___173876EA",
                        column: x => x.stor_id,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.ForeignKey(
                        name: "FK__roysched__title___15502E78",
                        column: x => x.title_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__sales__stor_id__1273C1CD",
                        column: x => x.stor_id,
                        principalTable: "stores",
                        principalColumn: "stor_id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK__sales__title_id__1367E606",
                        column: x => x.title_id,
                        principalTable: "titles",
                        principalColumn: "title_id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__titleauth__au_id__0CBAE877",
                        column: x => x.au_id,
                        principalTable: "authors",
                        principalColumn: "au_id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK__titleauth__title__0DAF0CB0",
                        column: x => x.title_id,
                        principalTable: "titles",
                        principalColumn: "title_id",
                        onDelete: ReferentialAction.Restrict);
